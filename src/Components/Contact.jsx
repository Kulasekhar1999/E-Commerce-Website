    ...
    <div className="contact-section">
      ...
      <div className="contact-card">
        ...
        <div className="contact-card">
         ...
         <p>With 900+ products and quality brands, you can choose the best products for your business.</p>
         </div>
    ...
    <div className="contact-showcase">
      <div className="contact-image">
        ...
        <div className="contact-info">
            ...
            <p>With our design tools, you can easily add your custom designs to t-shirts,mugs,phone cases, and hundred of other products.</p>
          ...
          <br/>
            ...
            <div className='contact-grid'>
              <div className='test-card'>
                ...
                <p className='contact-text'>
                  KK Fashions has  been an increadible service for us musicians unable to keep large amount of inventary -
                   now we can create designs preciously too expensive to print without having to have 1000 shirts in our jam space.
                </p>
                </div>
                </div>
          </div>
            ...
            <div className='contact-grid'>
              <div className='test-card'>
                ...
                <div className='stars'>*****</div>
                <p className='contact-text'>
                  We choose kk fashions because of their offerings as well as their incredibly low prices.
                  After several years, we have come to find that their customer service is also top notch, 
                  and their platform just keeps getting better and better.
                </p>
                </div>
              ...
              <div className='test-card'>
                ...
                <div className='stars'>*****</div>
                <p className='contact-text'>
                  kk fashions has been amazing as we grow our business, from the difference it can make for our customers to the customer servive
